        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                <div class='left-content'>
                    ...
                    <ul class='add'>
                        <li class='favorite-link' data-shopid=$shopID><a href='addToFavorite.php?id=$shopID'><i class='fa-regular fa-heart'></i>收藏</a></li>
                        <li class='collect-link'><a href='addToGallery.php?id=$shopID'><i class='fa fa-plus' aria-hidden='true'></i>去過</a></li>
                    </ul>
                    <div class='introduce'>
                        <h2>簡介</h2>
            ...
            <div id="commentFormOverlay" class="overlay">
                <div class="comment-form">
                    ...
                    <form action="process_comment.php" method="POST">
                        ...
                        <input type="hidden" id="selectedRating" name="selected_rating" value="">
                    ...
                    <button onclick='closeCommentForm()'>&times;</button>
                </div>
            </div>
            <!-- 彈出的評論表單模態視窗(修改) -->
            <div id="commentEditFormOverlay" class="Editoverlay">
                <div class="comment-form">
                    ...
                    <form action="update_comment.php" method="POST">
                        ...
                        <ul class='comment-rating'>
                            <span>極差</span>
                            <li class='rating-number' data-rating="1" onclick="setEditRating(1)"><i class="fa-solid fa-1"></i></li>
                            <li class='rating-number' data-rating="2" onclick="setEditRating(2)"><i class="fa-solid fa-2"></i></li>
                            <li class='rating-number' data-rating="3" onclick="setEditRating(3)"><i class="fa-solid fa-3"></i></li>
                            <li class='rating-number' data-rating="4" onclick="setEditRating(4)"><i class="fa-solid fa-4"></i></li>
                            <li class='rating-number' data-rating="5" onclick="setEditRating(5)"><i class="fa-solid fa-5"></i></li>
                            <span>非常好</span>
                        </ul>
                        <input type="hidden" id="selectedRating" name="selected_edit_rating" value="">
                        <textarea class='textarea-content' name="comment-content"><?php echo $row_comment_edit["Com_Content"];?></textarea>
                        <input type="submit" value="更新評論" class='comment-submit'>
                    </form>
                    <button onclick='closeEditCommentForm()'>&times;</button>
                </div>
            </div>
                ...
                <div class="comment-search">
                    <form action="search_comment.php" method="POST">
                        <input type="hidden" name="shop_id" value="<?php echo $row['shop_ID']; ?>">
                        <input type="text" placeholder="請輸入查詢評論關鍵字" name="comment-keyword" class="search-bar comment-search-bar"><i class="fa-solid fa-magnifying-glass" onclick="submitForm()"></i>
